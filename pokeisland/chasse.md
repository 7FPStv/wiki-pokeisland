...
La **Chasse** te permet de tenter ta chance en mode “détective Pokémon”. Tu lances une session, et au fil du temps tu peux capturer/tenter une chasse selon la mécanique du serveur. `/chasse`
