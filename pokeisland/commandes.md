---
description: >-
  Toutes les commandes utiles de PokeIsland, rangées par thème. À garder sous le
  coude.
icon: terminal
---
...
| Commande               | Effet                                                    |
| ---------------------- | -------------------------------------------------------- |
| `/dresseur`            | Ton niveau de [Dresseur](dresseur.md) et tes récompenses |
| `/rangs`               | Le menu des [Rangs](rangs.md)                            |
...
| `/toprank`       | Classement Ranked                      |
| `/tour`          | La [Tour de combat](tour-de-combat.md) |
| `/bf`            | La [Battle Factory](battle-factory.md) |
...
| Commande                                                                         | Effet                                               |
| -------------------------------------------------------------------------------- | --------------------------------------------------- |
| `/shop`                                                                          | Le [Marchand Shop](economie/marchand-shop.md)       |
| `/gts`                                                                           | Le [marché mondial](economie/gts.md)                |
...
| Commande     | Effet                              |
| ------------ | ---------------------------------- |
| `/is create` | Créer ton [île](ile-joueurs.md)    |
| `/pokeworld` | Le menu du [PokéWorld](pokeworld/) |
| `/spawn`     | Retour au spawn                    |
| `/home`      | Tes points de retour               |
...
{% hint style="info" %}
Certaines commandes dépendent de ton [rang](rangs.md) ou de ton grade. Si une commande te répond que tu n'as pas la permission, c'est qu'elle se débloque plus tard.
{% endhint %}
