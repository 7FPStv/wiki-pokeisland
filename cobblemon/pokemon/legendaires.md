---
description: >-
  Comment les légendaires apparaissent réellement sur PokeIsland : biomes,
  horaires, chances et catégories.
icon: dragon
---

# Légendaires

Les **Pokémon légendaires** ne sont pas là pour être capturés tous les jours. Sur PokeIsland, ils apparaissent selon un système **horaire, aléatoire et lié au biome**.

***

## Comment ça marche vraiment

Toutes les heures, à l'heure pile, le serveur fait un tirage :

1. Il tire au sort si une apparition a lieu — la chance dépend du **nombre de joueurs connectés**.
2. Il choisit un joueur au hasard parmi les connectés (les **AFK sont exclus**).
3. Il regarde dans **quel biome** ce joueur se trouve.
4. Il tire un légendaire dans le pool de ce biome.
5. Le Pokémon apparaît **à moins de 20 blocs** du joueur, au **niveau 70**.

{% hint style="danger" %}
Le légendaire **disparaît au bout de 15 minutes**. Une annonce est envoyée dans le chat au moment de l'apparition : si tu la vois, tu as un quart d'heure, pas plus.
{% endhint %}
...
Plus il y a de monde connecté, plus les légendaires sortent souvent.
...
Utilise `/legendaire` en jeu pour consulter les chances d'apparition là où tu te trouves.

***

## Ce que tu dois préparer

* Des **Poké Balls adaptées** aux rares (Hyper Ball, Chrono Ball…) — et de quoi payer leur coût en [énergie](../../pokeisland/energie.md).
* Une équipe capable d'affaiblir un Pokémon **niveau 70** sans le mettre KO.
* Une **Master Ball** si tu en as une en réserve. C'est exactement pour ce moment-là.

{% hint style="info" %}
Les captures de légendaires sont **annoncées à tout le serveur**. Prépare-toi à recevoir des messages privés.
{% endhint %}

***

## Les autres façons d'en obtenir
